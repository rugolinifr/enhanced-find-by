...
interface EnhancedCountInterface
{
     ...
     * The count is limited to a maximum of 30 entities, starting after the 60th.
     *
     * <code>
     * $count = $finder->count(
     *     from: Person::class,
     ...
     * @param int|null $limit the maximum number of entities to count, greater than 0, or `null` to count every matching entity.
     * @param int $offset the number of entities to skip before starting to count the result set,
